...
$sadsdsd = $db->prepare("SELECT count(*) FROM chat_users WHERE username= :h");
...
$resultas = $db->prepare("SELECT * FROM chat_users WHERE username= :a");
...
if ($wapakpak == 0) {
	...
	<br>
	<p> if you think there is an error please Contact one of our Excoss or send an email to help@digitalsoccersystem.com</p>
	<br>
	Powered By Gabriel
	</div>';
